...
import { getSearchEntities, getEntities, reset } from './brand.reducer';
...
export interface IBrandState extends IPaginationBaseState {
  search: string;
}

export class Brand extends React.Component<IBrandProps, IBrandState> {
  state: IBrandState = {
    search: '',
      ...
      <div>
        <h2 id="brand-heading">
          ...
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp; Create new Brand
          </Link>
        </h2>
        <Row>
          <Col sm="12">
